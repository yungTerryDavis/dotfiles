...
--   hl.exec_cmd("dbus-update-activation-enironment --systemd WAYLAND_DISPLAY XDG_CURRENT_DESKTOP")
end)
...
-- Default springs
hl.curve("easy",           { type = "spring", mass = 0.51, stiffness = 200, dampening = 20 })
